...
export default function Class() {
    ...
    useEffect(()=>{
        axios.get("http://localhost:3004/class").then(res => setClass(res.data))
    }, [])
      ...
      <div className="row">
        ...
        {/* {
          ...
          <div className="class-thumb">
            <img src="../../assets/images/class/yoga-class.jpg" className="img-fluid" alt="Class" />
        ...
        <div className="mt-5 mt-lg-0 mt-md-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay={500}>
          <div className="class-thumb">
            <img src="../../assets/images/class/crossfit-class.jpg" className="img-fluid" alt="Class" />
            <div className="class-info">
        ...
        <div className="mt-5 mt-lg-0 col-lg-4 col-md-6 col-12" data-aos="fade-up" data-aos-delay={600}>
          <div className="class-thumb">
            <img src="../../assets/images/class/cardio-class.jpg" className="img-fluid" alt="Class" />
            <div className="class-info">
